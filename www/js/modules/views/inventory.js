    ...
    var App = {
                    ...
                    sendScan: function () {
                        ...
                        Core.App.confirm("是否确认上传？", function () {
                            ...
                            native.dataCompress(tmp, function (text) {
                                Core.Service.post('api/auth/v1/ltl/sheetScanRecord/review', {
                                    batchNo: $vue.batchNo,
                                    loadShiftId: "",
                                    shopId: "",
                                    text: text
                                    ...
                                    $dbInnerManager.clearScanList(Core.ScanType.pd, function () {
                                        that.$data.scanList = [];
        ...
        getQR: function (e) {
            ...
            var params = {
                ...
                shopId: "",
                refId: "",
                isConsignNo: Core.Utils.isMySheet(code) ? 0 : 1
            };
            App.renderScanList(params);
        },
        ...
        initScanList: function () {
            ...
            //获取揽活列表
            $dbInnerManager.getScanList(Core.ScanType.pd, function (result) {
