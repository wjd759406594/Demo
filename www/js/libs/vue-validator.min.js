...
!function (t, i) {
    ...
    function r(t, i, e) {
        if (i = i.trim(), -1 === i.indexOf(" ")) return void e(t, i);
        for (var n = i.split(/\s+/), a = 0, o = n.length; o > a; a++) e(t, n[a])
    }

    function s(t) {
        if (Array.isArray(t)) {
            if (0 !== t.length) {
                for (var i = !0, e = 0, n = t.length; n > e && (i = s(t[e]), i); e++) ;
                return i
            }
            return !1
        }
        return "number" == typeof t || "function" == typeof t ? !0 : "boolean" == typeof t ? t : "string" == typeof t ? t.length > 0 : null !== t && "object" === ("undefined" == typeof t ? "undefined" : w["typeof"](t)) ? Object.keys(t).length > 0 : null === t || void 0 === t ? !1 : void 0
    }

    function l(t, i) {
        if ("string" != typeof i) return !1;
        var e = i.match(new RegExp("^/(.*?)/([gimy]*)$"));
        return e ? new RegExp(e[1], e[2]).test(t) : !1
    }

    function d(t, i) {
        return "string" == typeof t ? f(i, 10) && t.length >= parseInt(i, 10) : Array.isArray(t) ? t.length >= parseInt(i, 10) : !1
    }
    ...
    function g(t) {
        ...
        t.directive("validate-class", {
            terminal: !0, priority: i.priority + F, bind: function () {
                ...
                for (var e = a(t.childNodes), n = 0, o = e.length; o > n; n++) {
                    var r = e[n];
                    if (1 === r.nodeType) for (var s = r.hasAttributes(), l = s && a(r.attributes), d = 0, u = l.length; u > d; d++) {
                        var h = l[d];
                        if (h.name.match(N)) {
    ...
    function _(t) {
        ...
        var n = t.FragmentFactory, a = t.parsers.directive.parseDirective, o = t.util, r = o.inBrowser, s = o.bind,
            l = o.on, d = o.off, u = o.createAnchor, h = o.replace, c = o.camelize, f = o.isPlainObject, p = i();
        t.directive("validate", {
            ...
            bind: function () {
                var t = this.el, i = this.vm.$options._validator, e = t.getAttribute("v-model"),
                    n = this.parseModelRaw(e), a = n.model, o = n.filters;
                this.model = a, this.setupFragment(), this.setupValidate(i, a, o), this.listen()
            },
            update: function (t, i) {
                if (t && !this._invalid) {
                    f(t) || i && f(i) ? this.handleObject(t, i) : (Array.isArray(t) || i && Array.isArray(i)) && this.handleArray(t, i);
            ...
            setupValidate: function (t, i, e) {
                ...
                this.field = c(this.arg ? this.arg : n.field), this.validation = a.manageValidation(this.field, i, this.vm, this.getElementFrom(this.frag), this._scope, e, n.initial, this.isDetectBlur(n.detectBlur), this.isDetectChange(n.detectChange)), f(n.classes) && this.validation.setValidationClasses(n.classes), n.group && a.addGroupValidation(n.group, this.field), this._initialNoopValidation = this.isInitialNoopValidation(n.initial)
            },
            listen: function () {
                var t = this.model, i = this.validation, e = this.getElementFrom(this.frag);
                this.onBlur = s(i.listener, i), l(e, "blur", this.onBlur), "radio" !== e.type && "SELECT" !== e.tagName || t ? "checkbox" === e.type ? t ? (this.onClick = s(i.listener, i), l(e, "click", this.onClick)) : (this.onChange = s(i.listener, i), l(e, "change", this.onChange)) : t || (this.onInput = s(i.listener, i), l(e, "input", this.onInput)) : (this.onChange = s(i.listener, i), l(e, "change", this.onChange))
            },
            unlisten: function () {
                var t = this.getElementFrom(this.frag);
                this.onInput && (d(t, "input", this.onInput), this.onInput = null), this.onClick && (d(t, "click", this.onClick), this.onClick = null), this.onChange && (d(t, "change", this.onChange), this.onChange = null), this.onBlur && (d(t, "blur", this.onBlur), this.onBlur = null)
            },
            ...
            setupFragment: function () {
                this.anchor = u("v-validate"), h(this.el, this.anchor), this.factory = new n(this.vm, this.shimNode(this.el)), this.frag = this.factory.create(this._host, this._scope, this._frag), this.frag.before(this.anchor)
            },
            teardownFragment: function () {
                this.frag && (this.frag.remove(), this.frag = null, this.factory = null), h(this.anchor, this.el), this.anchor = null
            },
    ...
    function m(t) {
        var i = t.FragmentFactory, e = t.directive("if"), n = t.util, a = n.isArray, o = n.isPlainObject,
            r = n.createAnchor, s = n.replace, l = n.extend, d = n.camelize;
    ...
    function b(i) {
        ...
        return b.installed ? void t("already installed.") : (C.Vue = i, p(i), V(i), v(i), m(i), g(i), void _(i))
    }
    ...
    var C = {}, k = Object.freeze({required: s, pattern: l, minlength: d, maxlength: u, min: h, max: c}),
        E = "__vue-validator-validate-update__", A = 4096, F = 32, S = /[^|]\|[^|]/, N = /^v-validate(?:$|:(.*)$)/,
        x = /^v-on:|^@/, I = 0, O = function () {
            ...
            return t.prototype.manageElement = function (t, i) {
                ...
                var i = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], e = i.type,
                    n = void 0 === e ? null : e, a = i.noopable, o = void 0 === a ? !1 : a;
                ...
                var e = this, n = arguments.length <= 1 || void 0 === arguments[1] ? !1 : arguments[1],
                    a = arguments.length <= 2 || void 0 === arguments[2] ? null : arguments[2], o = C.Vue.util, r = {},
                    s = [], l = !0;
                this._runValidators(function (t, i, a) {
                    ...
                    if (u) {
                        ...
                        e._invokeValidator(e._vm, u, c, t.arg, function (n, o) {
                            if (n) r[i] = !n; else if (l = !1, o) s.push({
                                validator: i,
                                message: o
                            }), r[i] = o; else if (h) {
                                var d = {validator: i};
                ...
                return i && "blur" === i && !this.detectBlur ? !0 : i && "input" === i && !this.detectChange ? !0 : i && "change" === i && !this.detectChange ? !0 : i && "click" === i && !this.detectChange ? !0 : !1
                ...
                var e = C.Vue.util, n = e.addClass, a = e.removeClass, o = this._classes.valid || "valid",
                    s = this._classes.invalid || "invalid";
                i ? (r(t, o, n), r(t, s, a)) : (r(t, o, a), r(t, s, n))
            }, t.prototype._toggleTouched = function (t, i) {
                var e = C.Vue.util, n = e.addClass, a = e.removeClass, o = this._classes.touched || "touched",
                    s = this._classes.untouched || "untouched";
                i ? (r(t, o, n), r(t, s, a)) : (r(t, o, a), r(t, s, n))
            }, t.prototype._togglePristine = function (t, i) {
                var e = C.Vue.util, n = e.addClass, a = e.removeClass, o = this._classes.pristine || "pristine",
                    s = this._classes.dirty || "dirty";
                i ? (r(t, o, n), r(t, s, a)) : (r(t, o, a), r(t, s, n))
                ...
                var a = C.Vue.util.resolveAsset, o = this._getScope(), r = void 0, s = void 0, l = void 0, d = void 0,
                    u = void 0, h = void 0, c = void 0, f = void 0, p = void 0;
                for (h = 0, c = e.length; c > h; h++) if (r = e[h], s = a(this._vm.$options, "filters", r.name), s && (s = n ? s.write : s.read || s, "function" == typeof s)) {
                    if (l = n ? [t, i] : [t], u = n ? 2 : 1, r.args) for (f = 0, p = r.args.length; p > f; f++) d = r.args[f], l[f + u] = d.dynamic ? o.$get(d.value) : d.value;
            ...
            return w.inherits(i, t), i.prototype.manageElement = function (t, i) {
                ...
                }), -1 !== i && (this._inits.splice(i, 1), this._validator.validate({field: this.field}))
            }, i.prototype.willUpdateFlags = function () {
                var t = this, i = arguments.length <= 0 || void 0 === arguments[0] ? !1 : arguments[0];
                e(this._inits, function (e, n) {
            ...
            return w.inherits(i, t), i.prototype.manageElement = function (t, i) {
                ...
                for (var i = [], e = 0, n = t.options.length; n > e; e++) {
                    var a = t.options[e];
                    !a.disabled && a.selected && i.push(a.value)
                }
                return i
            }, i.prototype._setOption = function (t, i) {
                for (var e = 0, n = t.length; n > e; e++) for (var a = t[e], o = 0, r = i.options.length; r > o; o++) {
                    var s = i.options[o];
            ...
            return t.prototype.enableReactive = function () {
                ...
                for (var t = C.Vue.parsers.expression.isSimplePath, i = this._dir.el.attributes, e = 0, n = i.length; n > e; e++) {
                    var a = i[e].name;
                    if (x.test(a)) {
                        var o = i[e].value;
                ...
                var t = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0], i = t.el,
                    n = void 0 === i ? null : i, a = t.field, o = void 0 === a ? null : a, r = t.touched,
                    s = void 0 === r ? !1 : r, l = t.noopable, d = void 0 === l ? !1 : l, u = t.cb,
                    h = void 0 === u ? null : u;
                ...
                this._dir.vm.$validate = function () {
                    for (var i = arguments.length, n = Array(i), a = 0; i > a; a++) n[a] = arguments[a];
                ...
                var i = arguments.length <= 1 || void 0 === arguments[1] ? !1 : arguments[1],
                    e = arguments.length <= 2 || void 0 === arguments[2] ? !1 : arguments[2], n = this,
                    a = arguments.length <= 3 || void 0 === arguments[3] ? null : arguments[3],
                    o = arguments.length <= 4 || void 0 === arguments[4] ? null : arguments[4], r = this._scope,
                    s = this._getValidationFrom(t);
                ...
                for (var i = arguments.length, e = Array(i > 1 ? i - 1 : 0), n = 1; i > n; n++) e[n - 1] = arguments[n];
    ...
    return b.version = "2.1.6", "undefined" != typeof window && window.Vue && window.Vue.use(b), b
});